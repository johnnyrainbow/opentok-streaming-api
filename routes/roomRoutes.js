import { createRoom, getRoomByHostId, getAllRooms, joinRoom, getRoomBroadcast } from '../controllers/room'
...
module.exports = (app) => {
    ...
    app.get('/rooms/:id', checkJwt, tokenErr, implId, getRoomByHostId)
